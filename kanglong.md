...
* 根据历史回测，这个策略的最好年化收益在12%~~15%，所以它不会帮助你短时间内发财；
* 这个策略可能在长达5年的时间里一直跑不赢银行理财；
...
1. 市场出现系统性低估机会可以买入 (PE<7且PB<1且ROE>18%)
2. 单一标的PE、PB 处于最近5年历史区间30%以下，且PB<2，可以买入
3. PB处于最近5年历史区间30%以下，且PE<10 或 1/PE<十年期国债利率X2，可以买入
4. 对于消费指数、医药指数、养老指数等PB从未小于2的品种，我们只在PB,PE均在最近5年历史10%的区间内才买入一份，也就是百里挑一；

### 卖出条件

1. 市场出现系统性高估机会可以卖出 (PE>50或PB>4.5)
2. 单一标的PE、PB 处于历史70%以上可以卖出
3. 1/PE<市场能找到的最小无风险收益率，可以卖出置换
...
这种定投方法保证了我们每一次下注，都大概率会赢，最后积小胜为大胜--日拱一卒无有尽,功不唐捐终入海
...
这种策略的要点在于`坐的住`，因为它几乎必定要承受非常大的回撤；

根据统计，绝大多数人在亏损25%的时候，会变笨，这是人的基因决定的，和智力毫无关系，能在满仓亏损25%还能稳坐泰山的人，万中无一；

我们不是那个万中无一的人，所以永远永远不要让自己变笨；
...
A股一个市场周期在5-7年内，每周执行一次，根据我们的估值系统测算，5-7年里大概产生产生50次买入的机会
...
根据统计，当总收益超过400%的时候，还能沉住气不动的人，万中无一；我们是普通人，普通人就要做普通事；
